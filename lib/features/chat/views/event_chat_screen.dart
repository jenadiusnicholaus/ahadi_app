...
class _EventChatScreenState extends State<EventChatScreen> {
  ...
  void _initializeServices() {
    _chatService = Get.put(WebSocketService(), permanent: true);
  ...
  Future<void> _loadMessages() async {
    try {
      ...
      final messages = await _eventService.getEventMessages(widget.eventId);
      ...
      _chatService.connectToEventChat(widget.eventId);
      await _eventService.markMessagesAsRead(widget.eventId);
      _scrollToBottom();
    } catch (e) {
      _isLoading.value = false;
